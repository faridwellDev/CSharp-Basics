...
namespace Delegate4
{
    ...
    internal class Program
    {
        ...
        //Static Method
        public static void Sub(int x, int y) { Console.WriteLine(
            $"Subtraction of  {x} and {y} is : {x - y}");}
        //Non-Static Method
        public void Mul(int x, int y) { Console.WriteLine(
            $"Mulitiplication of {x} and {y} is : {x * y}");}
        //Non-Static Method
        ...
        static void Main(string[] args)
        {
            ...
            Delegate[] InvocationLsit = del5.GetInvocationList();
            Console.WriteLine("InvocationList:");
            foreach(var item in InvocationLsit) { Console.WriteLine($"{item}"); }
            Console.WriteLine();
